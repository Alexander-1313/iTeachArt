...
public interface StockFeignClient {
    ...
    FinancialReportDto getFinancialReport(@RequestParam String symbol);
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/stock/candle?resolution=M&from=1572651390&to=1582910590&token=btqbebn48v6t9hdd6cog")
